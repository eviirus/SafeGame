...
function GeneratedResultFields({ isVisible, result }) {
  ...
  // Handle showing and hiding content when a button is clicked
  const handleContentDisplay = (index) => {
    setVisibleIndexes(
      (prevIndexes) =>
        prevIndexes.includes(index)
          ? prevIndexes.filter((i) => i !== index) // Remove index if already in the array
          : [...prevIndexes, index] // Add index if not in the array
    );
  };
